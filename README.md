...
1. How to allow user to zoom in on the map
2. How to sort results by ratings

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/3cyD2qg.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The hardest part was finding how to use MapKit to retrieve the location from an address string.
